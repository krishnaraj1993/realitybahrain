...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the public 'App\Controller\Api\UsersController' shared autowired service.
     *
     * @return \App\Controller\Api\UsersController
     */
    protected function getUsersControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/UsersController.php';

        $this->services['App\\Controller\\Api\\UsersController'] = $instance = new \App\Controller\Api\UsersController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\Api\\UsersController', $this));
